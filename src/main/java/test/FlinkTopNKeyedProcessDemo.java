...
import pers.gaopeng.Event;
import pers.gaopeng.ClickSource;
import pers.gaopeng.UrlViewCount;
...
public class FlinkTopNKeyedProcessDemo {
        ...
        public void onTimer(long timestamp, OnTimerContext ctx, Collector<String> out) throws Exception {
            ...
            for (int i = 0; i < this.n; i++) {
                ...
                String info = "No." + (i + 1) + " "
                        ...
                        + "url：" + UrlViewCount.url + " " + "浏览量：" + UrlViewCount.count + "\n";
                result.append(info);
            }
            result.append("========================================\n");
            for (UrlViewCount urlViewCount : urlViewCountArrayList) {
                System.out.println("a-->>" + urlViewCount.windowEnd);
            }
            System.out.println();
